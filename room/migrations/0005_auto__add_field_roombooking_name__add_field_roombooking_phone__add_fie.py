...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomBooking.name'
        db.add_column('room_roombooking', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RoomBooking.phone'
        db.add_column('room_roombooking', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RoomBooking.email'
        db.add_column('room_roombooking', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoomBooking.name'
        db.delete_column('room_roombooking', 'name')

        # Deleting field 'RoomBooking.phone'
        db.delete_column('room_roombooking', 'phone')

        # Deleting field 'RoomBooking.email'
        db.delete_column('room_roombooking', 'email')
