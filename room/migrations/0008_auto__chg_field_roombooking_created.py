...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoomBooking.created'
        db.alter_column('room_roombooking', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'RoomBooking.created'
        db.alter_column('room_roombooking', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))
