...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu.url'
        db.add_column('pages_menu', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Menu.parent'
        db.add_column('pages_menu', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Menu'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Menu.sort'
        db.add_column('pages_menu', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Deleting field 'Page.sort'
        db.delete_column('pages_page', 'sort')


    def backwards(self, orm):
        # Deleting field 'Menu.url'
        db.delete_column('pages_menu', 'url')

        # Deleting field 'Menu.parent'
        db.delete_column('pages_menu', 'parent_id')

        # Deleting field 'Menu.sort'
        db.delete_column('pages_menu', 'sort')

        # Adding field 'Page.sort'
        db.add_column('pages_page', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)
    ...
    models = {
        ...
        'pages.menu': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pages.Menu']", 'null': 'True', 'blank': 'True'}),
